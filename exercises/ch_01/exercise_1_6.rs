...
fn update(app: &App, model: &mut Model, _update: Update) {
    ...
    model.acceleration.x= Perlin::new().get([random_range(0.0, 10.0) as f64, t as f64]) as f32;
    model.acceleration.y = Perlin::new().get([random_range(0.0, 10.0) as f64, t as f64]) as f32;
